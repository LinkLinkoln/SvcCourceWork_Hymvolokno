...
import "./metrologyPhoto.css"; // Оставим файл стилей без изменений
import parisCup from "../../../img/metrology.png"; // Картинка не меняется
  ...
  return (
    ...
    >
      <div className="parisText">
        ...
        <a className="shopButton" href="/login">
